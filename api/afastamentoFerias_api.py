...
async def enviar_requisicoes():
    ...
    for dt_ini, dt_fim in date_ranges:
        payload = {
            "report": {
                ...
                "group_by": "team",
                "row_filters": "",
                "columns": "employee_id,employee_name,registration_number,observation,is_medical_certificate,start_date,end_date",
                "format": "json",
    ...
    df.to_csv("absences_report.csv", index=False, encoding='utf-8')
    print("Arquivo CSV gerado: absences_report.csv")
